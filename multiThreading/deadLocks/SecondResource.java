...
/**
 * <b>Second Resource in Deadlock Example</b>
 * 
 * <p>This class represents the second resource in a potential deadlock scenario.
 * It demonstrates how circular wait conditions can lead to deadlocks.</p>
 * 
 * <p><b>Thread Safety:</b>
 * This class is thread-safe but can lead to deadlocks when used incorrectly
 * with FirstResource due to nested synchronized blocks.</p>
 */
public class SecondResource implements Resource {
    private final String name = "SecondResource";
    private final Object lock = new Object();

    /**
     * Method that can potentially cause a deadlock when called from multiple threads.
     * 
     * @param otherResource the first resource to interact with
     * @throws IllegalStateException if the thread is interrupted
     */
    public synchronized void method1(FirstResource otherResource) {
        ...
        System.out.println(Thread.currentThread().getName() + " - Invoking method2 on FirstResource");
    ...
    public void access(Resource other) {
        synchronized (lock) {
            ...
            if (other instanceof FirstResource) {
                ((FirstResource) other).safeAccess();
            }
        }
    }
